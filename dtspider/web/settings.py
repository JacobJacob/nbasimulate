#coding=utf-8
# Django settings for dtspider project.
from dtspider.config import DjangoSettings, DEBUG
import os
...
#    'dtspider.business.middleware.channel.ChannelMiddleware',
    'dtspider.common.jsonrpcserver.JSONRPCServerMiddleware',
#    'dtspider.common.staticgenerator.middleware.StaticGeneratorMiddleware',
    #'django.contrib.auth.middleware.AuthenticationMiddleware',
)

ROOT_URLCONF = 'dtspider.web.urls'
...
TEMPLATE_CONTEXT_PROCESSORS = (
   ...
   'dtspider.business.context_processors.data_total',
)
